...
class E3DC_RSCP_web:
    ...
    def buildVirtualConn(self):
        ...
        self.ws.send(virtualConn, websocket.ABNF.OPCODE_BINARY)  # type: ignore
    ...
    def registerConnectionHandler(
        ...
        self.ws.send(reply, websocket.ABNF.OPCODE_BINARY)  # type: ignore
    ...
    def on_message(self, message: bytes):
        ...
        if tag == RscpTag.SERVER_REQ_PING:
            ...
            self.ws.send(pingFrame, websocket.ABNF.OPCODE_BINARY)  # type: ignore
            return
            ...
            self.ws.send(  # type: ignore
                rscpFrame(responseContainer), websocket.ABNF.OPCODE_BINARY  # type: ignore bug in websocket-client
            )
    ...
    def _sendRequest_internal(
        ...
        self.ws.send(outerFrame, websocket.ABNF.OPCODE_BINARY)  # type: ignore
